...
public class HibernateCriterionBuilder extends FilterCriterionProcessor {
     ...
     */
    public static Long getRowCount(Session session, String entityName) {
        Criteria criteria = session.createCriteria(entityName);
     ...
     * calculate the number of pages).
     */
    public static Long getRowCount(Session session, Class persistentClass) {
        Criteria criteria = session.createCriteria(persistentClass);
        return getRowCount(criteria);
    }
     ...
     * calculate the number of pages).
     */
    public static Long getRowCount(Session session, String entityName, String alias) {
        Criteria criteria = session.createCriteria(entityName, alias);
        return getRowCount(criteria);
    }
     ...
     * calculate the number of pages).
     */
    public static Long getRowCount(Session session, Class persistentClass, String alias) {
        Criteria criteria = session.createCriteria(persistentClass, alias);
        return getRowCount(criteria);
    }
    ...
    public static Long getRowCount(Criteria criteria) {
        ...
        Object cnt = criteria.list().get(0);
        if(cnt == null)
           return null;
        if(cnt.getClass().equals(Integer.class) || cnt.getClass().equals(int.class))
			return (long) Integer.valueOf((String)cnt);
        return (Long) cnt;
    }
